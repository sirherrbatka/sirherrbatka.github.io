...
#+BEGIN_SRC common-lisp
  (let* ((path-to-data-directory "~/Datasets/")
         (file-range (cl-ds.fs:find `((:all-directories :path "/home/shka/Datasets/")
                                        (:all-files :predicate ,(lambda (x)
                                                                  (string= "csv" (pathname-type x))))))))
